...
public class ProductsController(IProductService productService) : ControllerBase
{
        ...
        [FromBody] CreateProductRequest body)
    {
        ...
        {
            return StatusCode(500, ApiResponse<object>.Fail("PRODUCT_CREATE_ERROR", "Error al crear producto"));
        }
    }
        ...
        [FromQuery] int pageSize = 10)
    {
        ...
        try
        {
            var result = await productService.GetPagedAsync(tenantId, page, pageSize);
            return Ok(result);
        }
        catch (DomainException ex)
        {
        ...
        {
            return StatusCode(500, ApiResponse<object>.Fail("PRODUCT_LIST_ERROR", "Error al listar productos"));
        }
    }
}
