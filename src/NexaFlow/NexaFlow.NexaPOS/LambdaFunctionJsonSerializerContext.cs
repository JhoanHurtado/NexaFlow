...
namespace NexaFlow.NexaPOS
{
    ...
    [JsonSerializable(typeof(UpdatedResponse))]
    [JsonSerializable(typeof(SaleStatusUpdatedResponse))]
    [JsonSerializable(typeof(SeedResponse))]
    [JsonSerializable(typeof(ApiResponse<UpdatedResponse>))]
    [JsonSerializable(typeof(ApiResponse<SaleStatusUpdatedResponse>))]
    [JsonSerializable(typeof(ApiResponse<SeedResponse>))]
